...
## For "MeshADV Mini" by FrequencyLabs  
...
1. **Definitions**  
   - **Licensed Work**: "MeshADV Mini" by FrequencyLabs, including all design files, schematics, source code, documentation, and any modifications made by others.
...
By using, copying, or modifying "MeshADV Mini" under these terms, You acknowledge and agree to comply with this license.
